...
class Employee_Login_System:
    def __init__(self,root):
        ...
        title = Label(login_frame,text='Employee Login',font=('Elephant',25,'bold'),bg='white').place(x=0,y=30,relwidth=1)
        ...
        btn_login = Button(login_frame,text='Log In',command=self.login,font=('Arial Rounded MT Bold',15),bg='#00B0F0',
                           activebackground='#00B0F0',fg='white',activeforeground='white',
            ...
            if self.Empid.get() == "" or self.password.get() == "":
                ...
                if user == None:
                    ...
                    if user[0] == 'Employee':
                        ...
                        messagebox.showerror('Error','Please Fill the correct Employee ID and Password!!',parent=self.root)
            ...
            if self.Empid.get() == "":
                ...
                if email == None:
                    ...
                    if chk == 'f':
                        ...
                        title = Label(self.forget_win,text='Reset Password',font=('times new roman',15,'bold'),bg='#3f51b5',
...
if __name__ == '__main__':
    root = Tk()
    obj = Employee_Login_System(root)
    root.mainloop()